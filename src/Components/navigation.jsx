...
const ProfileDropDown = (props) => {
    ...
    const navigation = [
        { title: "Panel", path: "javascript:void(0)" },
        { title: "Ayarlar", path: "javascript:void(0)" },
        { title: "Çıkış yap", path: "javascript:void(0)" },
    ]
        ...
        <div className={`relative ${props.class}`}>
            <div className="flex items-center space-x-4">
                ...
                <div className="lg:hidden">
                    <span className="block">Arda Bağçe</span>
                    <span className="block text-sm text-gray-500">ardabagce@gmail.com</span>
                </div>
            </div>
...
export default () => {
  ...
  const navigation = [
      { title: "Anasayfa", path: "javascript:void(0)" },
      { title: "Biralar", path: "javascript:void(0)" },
      { title: "Hakkımızda", path: "javascript:void(0)" },
      { title: "İletişim", path: "javascript:void(0)" },
  ]
    return (
            ...
            <div className="flex items-center space-x-8 py-3 px-4 max-w-screen-xl mx-auto">
                <div className="flex-none lg:flex-initial">
                    <a href="javascript:void(0)">
                        <img
                            src="https://cdn.worldvectorlogo.com/logos/lariat.svg" 
                            width={120} 
                            height={50}
                            alt="Site Logo"
                        />
